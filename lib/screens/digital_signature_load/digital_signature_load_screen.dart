...
class DigitalSignatureLoadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final FillInvoiceVModel _vmodel = context.watch<FillInvoiceVModel>();
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                AppRouter.push(context, SignatureScreen());
              },
              child: Container(
                height: 40,
                decoration: BoxDecoration(
