...
class MoveBarcodeScreenCubit extends Cubit<MoveBarcodeScreenState> {
  ...
  MoveBarcodeScreenCubit(this._getProductByBarcode,
      this._getMoveProductsFromCache, this._saveMoveProductsToCache)
  ...
  Future<void> getProductByBarcode({required String barcode}) async {
    ...
    result.fold(
      (l) {
        emit(MoveBarcodeScreenState.errorState(message: mapFailureToMessage(l)));
